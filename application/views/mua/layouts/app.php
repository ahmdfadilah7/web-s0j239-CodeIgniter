                            ...
                            <li class="nav-item dropdown">
                                ...
                                data-bs-toggle="dropdown" aria-expanded="false">
                                    <span class="fs-4 fw-bold" style="margin-right: 10px">
                                        <?= $this->session->userdata('nama_mua') ?> 
                                    </span>
                                    <?php
                                        if ($this->session->userdata('foto_mua') <> '') {
                                    ?>
                                        <img src="<?= base_url($this->session->userdata('foto_mua')) ?>" width="35" height="35" class="rounded-circle">
                                    <?php
                                        } else {
                                    ?>
