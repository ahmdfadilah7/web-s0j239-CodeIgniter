            ...
            <div class="d-flex align-items-center justify-content-center w-100">
                <div class="row justify-content-center w-100">
                    <div class="col-md-8 col-lg-6 col-xxl-3">
                        <div class="card mb-0">
                            <div class="card-body">
                                <h2 class="text-center">Login Make Up Artist</h2>
                                ...
                                <?php } ?>
                                <form action="<?= base_url('mua/proses_login') ?>" method="post">
                                    <div class="mb-3">
                                    ...
                                    <a href="<?=base_url('mua/register')?>" class="btn btn-outline-primary w-100 py-8 fs-4 mb-4 rounded-2">
                                        Register
                                    </a>
                                </form>
                            </div>
